...
public class Client extends GameShell {
	...
	public final void getPlayerExtended(Packet arg0, int arg1) {
		for (int var4 = 0; var4 < this.entityUpdateCount; var4++) {
			...
			this.getPlayerExtended(var7, var5, var6, arg0);
		}
	}
	...
	public final void handlePrivateChatInput(int arg0, int arg1) {
		int var4 = 0;
		for (int var5 = 0; var5 < 100; var5++) {
			if (this.messageText[var5] != null) {
				int var6 = this.messageType[var5];
	...
	public final void getPlayerExtended(int arg1, int arg2, ClientPlayer arg3, Packet arg4) {
		if ((arg1 & 0x1) == 1) {
			int var7 = arg4.g1();
